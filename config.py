CONFIG = {
    ...
    "USE_OPTUNA": True, # Hyperparameter tuning with Optuna
    ...
    "AUTOENCODER_PARAMS": { 
        "vae": {
            ...
            "encoder_layers": [[256, 128], [512, 256, 128]],#[512, 256, 128],#[256, 128], [512, 256, 128]],  # Encoder hidden layers
            ...
            "decoder_layers": [[128, 256], [128, 256, 512]], #[128, 256],# [128, 256], [128, 256, 512]],  # Decoder hidden layers
            "activation": "relu",

CONFIG = {
    ...
    "MODEL_PATH": "/Users/carlamiquelblasco/Desktop/MASTER SE/Q2/DAT255-DL/project_carla/VAE_Anomalie/saved_models/16042025",
    ...
    "AUTOENCODER_PARAMS": { 
        "vae": {
            ...
            "encoder_layers": [512, 256, 128],#[[256, 128], [512, 256, 128]],#[512, 256, 128],#[256, 128], [512, 256, 128]],  # Encoder hidden layers
            ...
            "decoder_layers": [128, 256, 512],#[[128, 256], [128, 256, 512]], #[128, 256],# [128, 256], [128, 256, 512]],  # Decoder hidden layers
            "activation": "relu",
        ...
        "rnn": {
            ...
            "encoder_layers":[[128, 64]],# [[128, 64], [256, 128]],
            "latent_dim": 64, #32,  # Default dimensionality of latent space
            "latent_dim_min": 32, # Optuna
            "latent_dim_max": 128, # Optuna
            "latent_dim_step": 32, # Optuna
